  ...
  <div class="grid grid-cols-8 pt-3 sm:grid-cols-10">
    ...
    <div class="col-span-2 hidden sm:block">
      <ul>
        ...
        <li class="mt-5 cursor-pointer border-l-2 border-transparent px-2 py-2 font-semibold transition hover:border-l-blue-700 hover:text-blue-700">daftar Barang</li>
